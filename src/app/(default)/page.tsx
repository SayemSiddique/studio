...
const AllergenIcon = () => (
  <svg className="w-6 h-6 sm:w-8 md:w-10 sm:h-8 md:h-10 text-yellow-400" fill="currentColor" viewBox="0 0 24 24">
...
const NutritionIcon = () => (
  <svg className="w-6 h-6 sm:w-8 md:w-10 sm:h-8 md:h-10 text-green-400" fill="currentColor" viewBox="0 0 24 24">
...
const WarningsIcon = () => (
  <svg className="w-6 h-6 sm:w-8 md:w-10 sm:h-8 md:h-10 text-red-400" fill="currentColor" viewBox="0 0 24 24">
...
export default function SplashScreen() {
  ...
  useEffect(() => {
    // Progress bar animation is 3s via CSS
    ...
    <div className="splash-background min-h-screen flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-8 sm:mb-12 animate-fadeIn [animation-delay:1s]">
          <p className="text-white text-lg sm:text-xl font-medium">Know what's in your food</p>
          <p className="text-gray-200 text-sm sm:text-base mt-1">Scan • Analyze • Eat Smart</p>
        </div>
        ...
        <div className="flex justify-center space-x-4 sm:space-x-6 md:space-x-8 mb-8 sm:mb-12">
          <div className="flex flex-col items-center animate-fadeIn [animation-delay:1.2s]">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center shadow-lg border border-white/30">
              <AllergenIcon />
            </div>
            <p className="text-xs text-center mt-2 text-white font-medium">Allergens</p>
          </div>
          <div className="flex flex-col items-center animate-fadeIn [animation-delay:1.4s]">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center shadow-lg border border-white/30">
              <NutritionIcon />
            </div>
            <p className="text-xs text-center mt-2 text-white font-medium">Nutrition</p>
          </div>
          <div className="flex flex-col items-center animate-fadeIn [animation-delay:1.6s]">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center shadow-lg border border-white/30">
              <WarningsIcon />
            </div>
            <p className="text-xs text-center mt-2 text-white font-medium">Warnings</p>
          </div>
        </div>

        {/* Loading Bar */}
        <div className="w-64 max-w-[90%] sm:w-72 bg-white/20 backdrop-blur-md rounded-full h-3 overflow-hidden mx-auto mb-3 border border-white/30">
          <div className="h-full bg-gradient-to-r from-green-400 to-teal-500 rounded-full animate-progress"></div>
        </div>
        <p className="text-gray-100 text-sm sm:text-base animate-fadeIn [animation-delay:1.8s]">Loading your healthy future...</p>
      </div>
    </div>
  );
}
